...
Project-specific facts that supplement the standard template above.
...
- (The 5-line CI YAML rule is covered by the template's "No Procedural Logic in CI/CD YAML" section above.)
...
Dev-Team: mcp-server-discord-watcher
